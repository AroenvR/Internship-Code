...
/**
 * This component is for giving an input of VisitId's and rendering their correspoding images from Muppets.
 * Input is up to 50 VisitId's (for now).
 */
const ClusterValidator = (props) => {
    ...
    const checkInput = (input) => {
        ...
        //TODO: There is a mistake with the Muppets that it cannot load more than 65 images at once.
        // Leaving the code above in case this issue gets solved.
    ...
    // Handle clicking of the 'Submit' button and sending data to the backend.
